 ...
 */
public class DifferentialDriveOdometry930 {
   ...
   */
  public DifferentialDriveOdometry930(Rotation2d gyroAngle, Pose2d initialPoseMeters) {
   ...
   * @param gyroAngle The angle reported by the gyroscope.
   */
  public DifferentialDriveOdometry930(Rotation2d gyroAngle) {
   ...
   * @param gyroAngle The angle reported by the gyroscope.
   */
  public void resetRotation(Rotation2d gyroAngle) {
    m_gyroOffset = m_poseMeters.getRotation().minus(gyroAngle);
