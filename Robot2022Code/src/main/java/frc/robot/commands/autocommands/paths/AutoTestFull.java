...
public class AutoTestFull extends PathPlannerSequentialCommandGroupUtility {
     ...
     * @param dSubsystem
     */
    public AutoTestFull(DriveSubsystem dSubsystem) { 
        ...
        Trajectory trajectory1 = PathPlanner.loadPath("AutoTestFull", KMAXSPEED, KMAXACCELERATION);
        ...
        Ramsete930Command ramseteCommand1 = new Ramsete930Command(
                ...
                addCommands(new ResetAutonomousCommand(trajectory1.getInitialPose(), dSubsystem),/*new EngageIntakePistonsCommand(intakePistonSubsystem), new RunIntakeMotorsCommand(intakeMotorSubsystem, false),*/ ramseteCommand1, new StopDrive(dSubsystem));
